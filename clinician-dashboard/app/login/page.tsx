				...
				<div className="max-w-md w-full space-y-8">
					...
					<div className="mt-6">
						...
						<div className="mt-6 grid gap-3">
							<button type="button" onClick={handleGoogleLogin} disabled={isGoogleLoading} className="cursor-pointer w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 disabled:opacity-70 disabled:cursor-not-allowed">
								{isGoogleLoading ? (
									<>
							...
							<button type="button" onClick={handleMicrosoftLogin} disabled={isAzureLoading} className="cursor-pointer w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 disabled:opacity-70 disabled:cursor-not-allowed">
								{isAzureLoading ? (
									<>
										<Loader2 className="w-5 h-5 mr-2 animate-spin" />
